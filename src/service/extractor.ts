...
export class LivingMemoryExtractor {
    ...
    private buildPrompt(
        ...
        const taskPrompt = [
            ...
            '- content必须使用第一人称视角,其中"我"指的就是你,自然描述你与对方之间的互动、关系、事实或偏好',
            ...
            '- 必须使用具体的昵称:在content、summary和keywords中,必须使用消息前缀中的具体昵称(如"张三"),绝对不能用"用户"、"对方"等泛化词汇替代',
            ...
            'content 应写成稳定、可复用、第一人称的记忆正文,不要写成主题标签或关键词列表。',
