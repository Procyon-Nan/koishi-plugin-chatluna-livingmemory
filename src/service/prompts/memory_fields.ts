...
export const MEMORY_CONTENT_REQUIREMENT =
    '- content：记忆正文，必须使用当前角色的第一人称关系视角（“我”即当前角色），体现其人格、语气、关注点与关系视角，口语化且自然地描述其与具体发言者之间的互动、关系、事实或偏好，追求详略得当，避免流水账；字数保持在 300 字以内。'
...
export const MEMORY_SPEAKER_REFERENCE_REQUIREMENT =
    '- 昵称要求：content、summary 和 keywords 中必须沿用输入材料中的具体昵称；绝对不能用“用户”、“对方”等泛化词汇或用户 ID 替代，也不要把多名用户混成同一个人。'
