...
import ProfileEditorDialog from './profile-editor-dialog.vue'
...
const editingProfile = ref<UserProfileRecord | null>(null)
const {
    items,
    page,
    pageSize,
...
const editUserProfile = (profile: UserProfileRecord) => {
